            ...
            <div class="card-body">
                ...
                <form action="update.php" method="post">
                    <div class="input-group mb-3">
                        <input type="text" name="mapel" value="<?= $row['mapel']; ?>" class="form-control" placeholder="Nama Mapel" aria-label="mapel" aria-describedby="basic-addon1" required>
                    </div>
                    <div class="input-group mb-3">
                        <input type="number" name="jam" value="<?= $row['jam']; ?>" class="form-control" placeholder="Jumlah Jam Pelajaran" aria-label="jam" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
